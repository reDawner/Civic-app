...
const adminNavItems = [
  { id: "dashboard", label: "System Analytics", path: "/admin" },
  { id: "categories", label: "Category Management", path: "/admin/categories" },
  { id: "mapping", label: "Authority Mapping", path: "/admin/mapping" },
  { id: "roles", label: "Manage Roles", path: "/admin/roles" },
];
        ...
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-2 px-2.5 py-1 rounded-full border border-slate-200">
              <div className="avatar-init w-7 h-7 rounded-full bg-gradient-to-br from-red-400 to-red-700 flex items-center justify-center text-white text-[0.7rem] font-bold">
                AD
              </div>
